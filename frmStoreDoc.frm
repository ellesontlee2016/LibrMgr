...
Begin VB.Form frmStoreDoc 
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      UserName        =   "Admin"
      Password        =   ""
      RecordSource    =   $"frmStoreDoc.frx":1CD0
   ...
   Begin VB.Frame Frame2 
      Caption         =   "Save Document to Database"
      Height          =   852
      Left            =   720
      TabIndex        =   4
      Top             =   7800
   ...
   Begin VB.Frame Frame1 
      Caption         =   "Get Document from Database"
      Height          =   852
      Left            =   5880
      TabIndex        =   0
      Top             =   7920
   ...
   Begin VB.Label Label2 
      Caption         =   "Trial Version: Limited to "
      ForeColor       =   &H00FF0000&
      Height          =   252
      Left            =   240
      TabIndex        =   12
...
End Sub
Public Sub AddRec(sec As String, orderNumber As Double, buff() As Byte)
    Dim i As Integer
    Dim myName As String
    myName = getClientName()
      If DataEnvironment2.cnnSection.State <> adStateOpen Then
      ...
      addDebug "defaultDocType=" & defaultDocType
      addDebug "KeppAlive=Yes"
      addDebug "Recordsource=" & myName
      addDebug "Description=null"
    
        DataEnvironment2.cmdInsertDocNew sec, orderNumber, "Internal", defaultDocType, buff, "Yes", "", myName, Now
...
Private Sub cmdBatchAdd_Click()
  ...
  'set the max buffer large enough to retrieve multiple files
   ...
   For c = 1 To Len(CommonDialog1.filename)
    ...
    incD = 2
        ...
        If docName <> "" Then
         ...
         addDebug "(1) add record wit secName=" & secName & " with order=" & CDbl(originalIndex - incD * 0.001)
        Sleep 2000
    ...
    incD = CDbl(i)
        ...
        addDebug "(2) add record wit secName=" & secName
        Sleep 2000
   ...
   ' Me.Adodc1.Recordset.Requery
    'Me.Adodc1.Refresh
    addDebug "(3) Before sort "

   cmdSort_Click
     addDebug "(4) Before sort "
...
Private Sub Form_Activate()
    ...
    Directory_Root = myRegConAgent.GetRegValue(HKEY_CURRENT_USER, "Software\VB and VBA Program Settings\CorsPro\Settings", "Directory_Company")
